...
public class ChooseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Choose Team</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<form method='post'>");
            out.println("<h1>Select team to edit:</h1>");
            StringBuilder htmlTeams = new StringBuilder();
            int teamCounter = 0;
            for (Team team : teamList) {
                htmlTeams.append("<input type='radio' name='edit").append("'")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int indexToEdit = Integer.parseInt(request.getParameter("edit"));
        request.getSession().setAttribute("teamToEdit", indexToEdit);
        response.sendRedirect("/EsportWeb/Edit");
    }
